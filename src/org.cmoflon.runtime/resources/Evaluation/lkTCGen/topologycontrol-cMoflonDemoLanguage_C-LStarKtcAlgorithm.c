...
#include "topologycontrol-cMoflonDemoLanguage_C-LStarKtcAlgorithm.h"
...
#if COMPONENT_TOPOLOGYCONTROL == COMPONENT_TOPOLOGYCONTROL_CMOFLONDEMOLANGUAGE_C_LSTARKTCALGORITHM
