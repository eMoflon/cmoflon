...
1. Copy *$ToCoCo/src/app-conf-default*, remove the *_default* suffix and adjust the settings within to your wishes
1. Copy *$ToCoCo/src/Makefile-conf-default.include*, remove the *_default*, link to the contiki path in the vm
 * **Do not use IPv6** (the resulting image would be too large for Sky motes)
